...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, auth_1.hashPassword)(admin.password)];
                case 1:
                ...
                case 2:
                    user = _a.sent();
                    console.log("[Seed] Admin user ready: ".concat(user.email));
                    return [2 /*return*/];
            }
        });
    });
...
main()
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, prisma_1.closePrisma)()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
